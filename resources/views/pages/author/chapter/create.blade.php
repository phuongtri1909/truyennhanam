...
@section('info_title', 'Thêm chương')
...
<div class="author-application-form-wrapper author-story-compact">
    ...
    <form action="{{ route('author.stories.chapters.store', $story) }}" method="POST">
        @csrf
        <h6 class="author-form-section-title">
            <i class="fa-solid fa-plus me-2"></i> Thêm chương mới
        </h6>
        <div class="row">
            <div class="col-md-6">
                <div class="form-group author-form-group">
                    ...
                    <div class="author-input-wrapper">
                        ...
                        <input type="number" name="number" id="number" class="form-control author-form-input" value="{{ old('number', $nextChapterNumber) }}" required>
                    </div>
            ...
            <div id="scheduled-wrapper" class="col-12" style="display: none;">
                <div class="form-group author-form-group">
                    <div class="form-check form-switch mb-2">
                        <input type="checkbox" class="form-check-input" id="need_scheduled" {{ old('scheduled_publish_at') ? 'checked' : '' }}>
                        <label class="form-check-label" for="need_scheduled">Hẹn giờ đăng</label>
                    </div>
                    <div id="scheduled-input-container" style="display: none;">
                        <div class="author-input-wrapper">
            ...
            <div class="col-12">
                <div class="form-group author-form-group">
                    <div class="form-check form-switch">
                        <input type="checkbox" name="is_free" class="form-check-input" id="is_free" checked>
            ...
            @endif
            @if(($story->story_type ?? 'normal') !== 'zhihu')
            <div id="password-section" class="col-12" style="display: none;">
                <div class="form-group author-form-group">
                    <label class="author-form-label">Chương có mật khẩu không?</label>
                    <div class="d-flex flex-wrap gap-3">
                        <div class="form-check">
                            <input type="radio" name="has_password" id="has_password_no" value="0" class="form-check-input" checked>
                        ...
                        <div class="form-check">
                            <input type="radio" name="has_password" id="has_password_yes" value="1" class="form-check-input">
                ...
                <div id="password-fields" style="display: none;">
                    <div class="form-group author-form-group">
                        ...
                        <div class="author-input-wrapper position-relative">
                            ...
                            <input type="password" name="chapter_password" id="chapter_password" class="form-control author-form-input" placeholder="Nhập mật khẩu" autocomplete="off">
                    ...
                    <div class="form-group author-form-group">
                        ...
                        <textarea name="password_hint" id="password_hint" class="form-control author-form-textarea" rows="2" placeholder="Ví dụ: Nhập phép tính 1 + 1 = ? hoặc hướng dẫn tìm mật khẩu..."></textarea>
            ...
            <div class="col-12">
                <div class="form-group author-form-group">
                    ...
                    <div class="author-input-wrapper">
                        ...
                        <input type="text" name="title" id="title" class="form-control author-form-input" value="{{ old('title') }}" placeholder="Chương 1" required>
                    </div>
            ...
            <div class="col-12">
                <div class="form-group author-form-group">
                    ...
                    <textarea name="content" id="content" class="form-control author-form-textarea" rows="36" required>{{ old('content') }}</textarea>
            ...
            <div class="col-12">
                <div class="author-form-submit-wrapper">
                    <button type="submit" class="btn author-form-submit-btn me-2">
                        <i class="fa-solid fa-save me-2"></i> Lưu chương
                    </button>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function togglePasswordFields() {
        ...
        if (fields && hasYes) {
            ...
            if (!hasYes.checked) {
                ...
                document.getElementById('chapter_password').setAttribute('required', 'required');
    ...
    needScheduled.addEventListener('change', function() {
        if (this.checked) {
            fetch('{{ route("author.get-server-time") }}').then(r => r.json()).then(d => {
                if (d.time && !scheduledInput.value) scheduledInput.value = d.time;
            }).catch(() => {});
        }
    });
    document.querySelector('form').addEventListener('submit', function(e) {
        ...
        if (hasYes && hasYes.checked) {
            var pw = document.getElementById('chapter_password');
            var hint = document.getElementById('password_hint');
            if (!pw.value.trim()) {
                e.preventDefault();
                if (typeof Swal !== 'undefined') Swal.fire('Thiếu mật khẩu', 'Vui lòng nhập mật khẩu chương.', 'warning');
                else alert('Vui lòng nhập mật khẩu chương.');
                return false;
            }
            if (!hint.value.trim()) {
                e.preventDefault();
